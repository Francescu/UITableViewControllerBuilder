...
- (NSURL *)applicationFilesDirectory
{
    ...
    return [appSupportURL URLByAppendingPathComponent:@"Francescu.FScreenBuilder"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FScreenBuilder" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"FScreenBuilder.storedata"];
